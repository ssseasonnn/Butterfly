...
dependencies {
  implementation 'com.github.ssseasonnn.Butterfly:butterfly:1.2.3'
  kapt 'com.github.ssseasonnn.Butterfly:compiler:1.2.3'

  //for compose
  implementation 'com.github.ssseasonnn.Butterfly:butterfly-compose:1.2.3'
}
```
